...
override PKGDIR = xconfig_DisparityOmp
...
C:/Users/Hassan/workspace_v5_5/DisparityOmp/platform/config.bld:
package.mak: C:/Users/Hassan/workspace_v5_5/DisparityOmp/platform/config.bld
...
ti.targets.elf.C66.rootDir ?= C:/PROGRA~2/TEXASI~1/C6000C~1.0
...
package/%.xdc.inc package/%_xconfig_DisparityOmp.c package/%.defs.h: %.xdc $(PKGCFGS)
	@$(MSG) generating interfaces for package xconfig_DisparityOmp" (because $@ is older than $(firstword $?))" ...
	$(XSRUN) -f xdc/services/intern/cmd/build.xs $(MK_IDLOPTS) -m package/package.xdc.dep -i package/package.xdc.inc package.xdc

.dlls,e66 .dlls: DisparityOmp.pe66

-include package/cfg/DisparityOmp_pe66.mak
-include package/cfg/DisparityOmp_pe66.cfg.mak
ifeq (,$(MK_NOGENDEPS))
-include package/cfg/DisparityOmp_pe66.dep
endif
DisparityOmp.pe66: package/cfg/DisparityOmp_pe66.xdl
	@


ifeq (,$(wildcard .libraries,e66))
DisparityOmp.pe66 package/cfg/DisparityOmp_pe66.c: .libraries,e66
endif

package/cfg/DisparityOmp_pe66.c package/cfg/DisparityOmp_pe66.h package/cfg/DisparityOmp_pe66.xdl: override _PROG_NAME := DisparityOmp.xe66
package/cfg/DisparityOmp_pe66.c: package/cfg/DisparityOmp_pe66.cfg

clean:: clean,e66
	-$(RM) package/cfg/DisparityOmp_pe66.cfg
	-$(RM) package/cfg/DisparityOmp_pe66.dep
	-$(RM) package/cfg/DisparityOmp_pe66.c
	-$(RM) package/cfg/DisparityOmp_pe66.xdc.inc

clean,e66::
	-$(RM) DisparityOmp.pe66
.executables,e66 .executables: DisparityOmp.xe66

DisparityOmp.xe66: |DisparityOmp.pe66

-include package/cfg/DisparityOmp.xe66.mak
DisparityOmp.xe66: package/cfg/DisparityOmp_pe66.oe66 
	$(RM) $@
	@$(MSG) lnke66 $@ ...
	$(RM) $(XDCCFGDIR)/$@.map
	$(ti.targets.elf.C66.rootDir)/bin/lnk6x -w -q -u _c_int00 -fs $(XDCCFGDIR)$(dir $@).  -q -o $@ package/cfg/DisparityOmp_pe66.oe66   package/cfg/DisparityOmp_pe66.xdl --abi=eabi -c -m $(XDCCFGDIR)/$@.map -l $(ti.targets.elf.C66.rootDir)/lib/libc.a
	
DisparityOmp.xe66: export C_DIR=
DisparityOmp.xe66: PATH:=$(ti.targets.elf.C66.rootDir)/bin/;$(PATH)
DisparityOmp.xe66: Path:=$(ti.targets.elf.C66.rootDir)/bin/;$(PATH)

DisparityOmp.test test,e66 test: DisparityOmp.xe66.test

DisparityOmp.xe66.test:: DisparityOmp.xe66
ifeq (,$(_TESTLEVEL))
	@$(MAKE) -R -r --no-print-directory -f $(XDCROOT)/packages/xdc/bld/xdc.mak _TESTLEVEL=1 DisparityOmp.xe66.test
else
	@$(MSG) running $<  ...
	$(call EXEC.DisparityOmp.xe66, ) 
endif

clean,e66::
	-$(RM) .tmp,DisparityOmp.xe66,0,*


clean:: clean,e66

clean,e66::
	-$(RM) DisparityOmp.xe66
clean:: 
	-$(RM) package/cfg/DisparityOmp_pe66.pjt
%,copy:
	@$(if $<,,$(MSG) don\'t know how to build $*; exit 1)
	@$(MSG) cp $< $@
	$(RM) $@
	$(CP) $< $@
DisparityOmp_pe66.oe66,copy : package/cfg/DisparityOmp_pe66.oe66
DisparityOmp_pe66.se66,copy : package/cfg/DisparityOmp_pe66.se66

$(XDCCFGDIR)%.c $(XDCCFGDIR)%.h $(XDCCFGDIR)%.xdl: $(XDCCFGDIR)%.cfg .interfaces $(XDCROOT)/packages/xdc/cfg/Main.xs
	@$(MSG) "configuring $(_PROG_NAME) from $< ..."
	$(CONFIG) $(_PROG_XSOPTS) xdc.cfg $(_PROG_NAME) $(XDCCFGDIR)$*.cfg $(XDCCFGDIR)$*

.PHONY: release,xconfig_DisparityOmp
xconfig_DisparityOmp.tar: package/package.bld.xml
xconfig_DisparityOmp.tar: package/build.cfg
xconfig_DisparityOmp.tar: package/package.xdc.inc
ifeq (,$(MK_NOGENDEPS))
-include package/rel/xconfig_DisparityOmp.tar.dep
endif
package/rel/xconfig_DisparityOmp/xconfig_DisparityOmp/package/package.rel.xml: .force
	@$(MSG) generating external release references $@ ...
	$(XS) $(JSENV) -f $(XDCROOT)/packages/xdc/bld/rel.js $(MK_RELOPTS) . $@

xconfig_DisparityOmp.tar: package/rel/xconfig_DisparityOmp.xdc.inc package/rel/xconfig_DisparityOmp/xconfig_DisparityOmp/package/package.rel.xml
	@$(MSG) making release file $@ "(because of $(firstword $?))" ...
	-$(RM) $@
	$(call MKRELTAR,package/rel/xconfig_DisparityOmp.xdc.inc,package/rel/xconfig_DisparityOmp.tar.dep)


release release,xconfig_DisparityOmp: all xconfig_DisparityOmp.tar
clean:: .clean
	-$(RM) xconfig_DisparityOmp.tar
	-$(RM) package/rel/xconfig_DisparityOmp.xdc.inc
	-$(RM) package/rel/xconfig_DisparityOmp.tar.dep
...
include custom.mak
clean:: 
	-$(RM) package/xconfig_DisparityOmp.pjt
